...
def lnprior(theta):
	...
	if -100 < rvsys < 100 and -2 < logk < 3 and 57975<T0<58025 and 42<period<42.5 and 0<sig2<10:
		lnp_per=-0.5*(period-42.295)**2/(0.002**2)
		if fix_ecc==False:
...
initial=[0,40,0,0.1,58000,42.3,1]

if fix_ecc:
	labels=labels[0:2]+labels[-3:]
	initial=initial[0:2]+initial[-3:]
